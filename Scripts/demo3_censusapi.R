## ------------------------------
## 
## Demo 3: Using the censusapi package
##
## Purpose of script: To demonstrate how to use the censusapi package 
## to access the Census Bureau's Census Data API. This script was
## created for demonstration purposes for the Working with APIs and 
## Census Data in R workshop held on February 12, 2021 by JHU Data 
## Services for Love Data Week 2021. 
## 
## Author: Reina Chano Murray, JHU Data Services
## 
...
## DEMO 1
##
## Start by viewing the list of census apis accessible through this package
