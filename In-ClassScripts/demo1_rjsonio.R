## ------------------------------
##
## Demo 1: Using the Census API Directly
##
## Purpose of script: To demonstrate how to make requests to the US 
## Census Bureau's Census Data API directly from R. This script was
